 ...
 */
package io.enlithamster.github.entity.passive;
...
public class MMP_PinkletEntity
extends AnimalEntity
implements ItemSteerable,
Saddleable {
    private static final TrackedData<Boolean> SADDLED = DataTracker.registerData(MMP_PinkletEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Integer> BOOST_TIME = DataTracker.registerData(MMP_PinkletEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final Ingredient BREEDING_INGREDIENT = Ingredient.ofItems(Items.CARROT, Items.POTATO, Items.BEETROOT);

    public static final EntityType<MMP_PinkletEntity> PINKLET = register(
        "pinklet", 
        EntityType.Builder.create(MMP_PinkletEntity::new, SpawnGroup.CREATURE)
    ...
    public MMP_PinkletEntity(EntityType<? extends MMP_PinkletEntity> entityType, World world) {
    ...
    @Override
    @Nullable
    public MMP_PinkletEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        return PINKLET.create(serverWorld);
    }
